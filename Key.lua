...
local Config = {
    ...
    ServiceId       = 26013, -- Your PlatoBoost Service ID
    PlatoSecret     = "3390c5ad-cdb8-46de-8718-233a19040c6a", -- Your PlatoBoost Secret Key
    ...
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/rootzero001-code/Keysystem/refs/heads/main/Script.lua", -- The raw URL of your main script
    ...
    -- [6] GUI Management
    OldGuiName      = "any", -- Name of the old GUI to destroy if it's already open
    MainGuiName     = "arw", -- Name of the main script's GUI to check if it's already executing

    -- [7] Hub Information & UI Text
    HubName         = "wer", -- The main title shown at the top of the GUI
    HubDescription  = "xer" -- The text shown below the title
}
